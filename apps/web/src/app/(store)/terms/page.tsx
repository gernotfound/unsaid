...
export default function TermsPage() {
  ...
  return (
    <main id="main" className="legal-page">
      <p className="eyebrow">NOTE LEGALI / TERMINI</p>
      <h1>Termini d&apos;uso.</h1>
      ...
      <div className="legal-status">
        <strong>VENDITE / DISATTIVATE</strong>
        <p>
          {legal.commerceIdentityReady
            ? "L'identità commerciale è configurata, ma la vendita resta disattivata finché il sistema di ordine non viene abilitato."
      ...
      <section className="legal-section">
        ...
        <div>
          <h2>Oggetto</h2>
          <p>
            Il sito presenta il progetto UNSAID, il suo archivio editoriale e concetti e prodotti in preparazione.
      ...
      <section className="legal-section">
        ...
        <div>
          ...
          <p>
            Finché il sistema di ordine è disattivato, selezioni di taglia, prezzi dimostrativi, pulsanti disabilitati o altre
      ...
      <section className="legal-section">
        ...
        <div>
          ...
          <p>
            Immagini, colori, bozze visive, testi, disponibilità e dettagli di prodotto della fase di sviluppo possono
            cambiare prima della vendita. Le caratteristiche definitive dei beni saranno indicate nelle relative
            pagine prodotto quando la vendita sarà operativa.
          </p>
        </div>
      </section>
      ...
      <section className="legal-section">
        ...
        <div>
          <h2>Prima dell&apos;apertura delle vendite</h2>
          <p>
            Questi termini saranno sostituiti o integrati da condizioni generali di vendita complete prima di
            consentire ordini. Il sistema applicativo richiede inoltre un controllo legale separato prima di considerare
            le vendite effettivamente abilitate.
          </p>
